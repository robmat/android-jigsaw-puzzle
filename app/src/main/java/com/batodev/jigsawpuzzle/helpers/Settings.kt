...
class Settings {
     ...
     */
    var lastSetDifficultyCustomHeight = DEFAULT_DIFFICULTY_HEIGHT

    /**
     * The last set custom width for the puzzle difficulty.
     */
    var lastSetDifficultyCustomWidth = DEFAULT_DIFFICULTY_WIDTH
     ...
     * The key is the difficulty (e.g., "3x5") and the value is a list of high score strings
     * (e.g., "MM:SS - YYYY-MM-DD HH:MM").
     */
